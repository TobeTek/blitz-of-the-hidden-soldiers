...
contract RevealBoardPositionsPlonkVerifier {
    // Omega
    ...
    uint16 constant nPublic   = 40;
    uint16 constant nLagrange = 40;
    
    uint256 constant Qmx  = 16066532085461915688618946829573986579824556209118709687450541499759799752513;
    uint256 constant Qmy  = 9609103961813249137146286757166521290344809337919088154045455440133466025679;
    uint256 constant Qlx  = 259246382507192227833807568149216943245196343560406533666071742681094180337;
    uint256 constant Qly  = 3955122577685757465128861558215707538122048872509634683681172551242675195634;
    uint256 constant Qrx  = 14374701011700692571529633175794982240232031775838408826696343535137228995425;
    uint256 constant Qry  = 10289618389187371550966220992958779201152815954949776853189244746371859524152;
    uint256 constant Qox  = 10692833903755319131832003796929029810971510865337671449453402720822436935969;
    uint256 constant Qoy  = 2236781228785467165384972156205860427659977643085476565733000584038703994253;
    uint256 constant Qcx  = 5472624021870836894828616621504769344856852386763821758353102961107000972179;
    uint256 constant Qcy  = 9536039305848043360934265444206547590957228436018273383408280196026815699531;
    uint256 constant S1x  = 10676884356849134270256686498204738921824685554647891603637771721013420064530;
    uint256 constant S1y  = 18971093427941900873605226562593035962206962920943413630594939343019433792269;
    uint256 constant S2x  = 3121047617410736922062749549077053540659386088556448712937483725175536635932;
    uint256 constant S2y  = 3155264415663641703829786291801910998862337511866187191262815173174488067650;
    uint256 constant S3x  = 14087673795075242826603663623022058517400240245019905154110389601742736033446;
    uint256 constant S3y  = 14448237401300168425812999375244520776437720326704297873115578333162488727065;
    ...
    uint16 constant lastMem = 2080;

    function verifyProof(uint256[24] calldata _proof, uint256[40] calldata _pubSignals) public view returns (bool) {
        assembly {
            /////////
            ...
            function calculateChallenges(pMem, pPublic) {
                ...
                mstore(add(mIn, 1792 ), calldataload(pA))
                mstore(add(mIn, 1824 ), calldataload(add(pA, 32)))
                mstore(add(mIn, 1856 ), calldataload(pB))
                mstore(add(mIn, 1888 ), calldataload(add(pB, 32)))
                mstore(add(mIn, 1920 ), calldataload(pC))
                mstore(add(mIn, 1952 ), calldataload(add(pC, 32)))
                
                beta := mod(keccak256(mIn, 1984), q) 
            ...
            function calculateLagrange(pMem) {
                ...
                inverseArray(add(pMem, pZhInv), 41 )
