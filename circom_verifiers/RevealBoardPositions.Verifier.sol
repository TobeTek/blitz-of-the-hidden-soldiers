...
contract PlonkVerifier {
    ...
    uint16 constant nPublic   = 32;
    uint16 constant nLagrange = 32;
    
    uint256 constant Qmx  = 9347786282009770658820631398596146901718008985559554187678470312778643217239;
    uint256 constant Qmy  = 4154275525882043021320565197972330533949149263161535587047893441250178123778;
    uint256 constant Qlx  = 13068437916729979077301068417164361922726751180794794345599354196741392844599;
    uint256 constant Qly  = 4289257471033900771773232884070087277630759643026758563479350436148340370244;
    uint256 constant Qrx  = 15388362645598380648941918336497770649628414589541875137342484636411464713363;
    uint256 constant Qry  = 5825266764967016917249878845367248175097059754267538694379356417617794321099;
    uint256 constant Qox  = 3867881407342704329040906916154307782968992747161977174887134711609329148541;
    uint256 constant Qoy  = 21340838928036718045921673218668265330179081852412497675459835163607765625784;
    uint256 constant Qcx  = 5929810427526201892491118500196907155435152744258798014381290583434926907837;
    uint256 constant Qcy  = 19901775411422111700143480665277064506481105099493892488129421020932977583312;
    uint256 constant S1x  = 14701970676014507248653998493980606035430134867532868635139326369084720574150;
    uint256 constant S1y  = 18906307778579051350175012706069979099956922302147258027381787407632245356814;
    uint256 constant S2x  = 2460444546182268221618017643442131042783718545009689598504373165999206418965;
    uint256 constant S2y  = 20699808332791178734343230851357608651353270979075591829853446095056906048156;
    uint256 constant S3x  = 13194820299791372348195760257618937339953715843740850541908413283892511839112;
    uint256 constant S3y  = 11815413838925489364176829737062796380775506250894411073199672935421651986458;
    ...
    uint16 constant lastMem = 1824;

    function verifyProof(uint256[24] calldata _proof, uint256[32] calldata _pubSignals) public view returns (bool) {
        assembly {
            /////////
            ...
            function calculateChallenges(pMem, pPublic) {
                ...
                mstore(add(mIn, 1536 ), calldataload(pA))
                mstore(add(mIn, 1568 ), calldataload(add(pA, 32)))
                mstore(add(mIn, 1600 ), calldataload(pB))
                mstore(add(mIn, 1632 ), calldataload(add(pB, 32)))
                mstore(add(mIn, 1664 ), calldataload(pC))
                mstore(add(mIn, 1696 ), calldataload(add(pC, 32)))
                
                beta := mod(keccak256(mIn, 1728), q) 
            ...
            function calculateLagrange(pMem) {
                ...
                inverseArray(add(pMem, pZhInv), 33 )
